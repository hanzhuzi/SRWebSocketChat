...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _userNameLabel.text = @"黯丶野火";
        [self.contentView addSubview:_userNameLabel];
        
        [_userNameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.leading.equalTo(weakSelf.headerImageView.mas_trailing).offset(10.0);
        ...
        UIImage * boubbleImage = [UIImage imageNamed:@"srchat_boubble_incomming"];
        ...
        [_textMessageLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.leading.equalTo(weakSelf.bubbleImageView.mas_leading).offset(15.0);
            make.trailing.equalTo(weakSelf.bubbleImageView.mas_trailing).offset(-5.0);
